...
To show this, consider parking functions with cars colored red and indigo, where the $i$ indigo cars form a parking function of length $i$ and the remaining red cars prefer the ``forbidden" spots in $$
