...
\todo[jayden, inline]{preference-restricted parking functions as a paradigm, something between parking functions and $\mathbf{u}$-parking functions. Maybe cut out results that are too specific to a particular restriction --- use the narrative as a guide for what to cut}
