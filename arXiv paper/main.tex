...
\begin{restatable}{theorem}{modPFcountGen}
	Given $g,s\in\mathbb{N},$ $1\le k\le gs,$ the number of parking functions of length $gs - k$ with gap $g$ between possible preferred spots is $\mathrm{PF}_{gs - k \mid S \cap [gs - k]}$ and satisfies the relation
	\begin{align*}
