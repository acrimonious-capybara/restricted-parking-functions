...
\begin{figure}[ht]
	\centering
	\includegraphics[width = 0.45 \textwidth]{modPFs}
	\includegraphics[width = 0.45 \textwidth]{modPFs2}
	\caption{Blake and Konheim's row parking function where cars 1, 4, 5, and 7 prefer the first row, cars 2 and 3 prefer the second row and car 6 prefers the last row can be understood as a restricted parking function $\pi = (1, 4, 4, 1, 1, 7, 1) \in \mathrm{PF}_{7 \mid \{ 1, 4, 7 \}}$}
\end{figure}
...
\begin{proof}
    ...
    \begin{figure}[H]
    	\centering
	\includegraphics[width = 0.45 \textwidth]{modPFs3}
	\includegraphics[width = 0.45 \textwidth]{modPFs4}
