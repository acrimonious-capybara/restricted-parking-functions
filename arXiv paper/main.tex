...
\begin{theorem}
    ...
    \]
    Here $l_{n, i}$ is the length of the longest contiguous string in $\sigma$ (written in one-line notation as $\sigma_{1} \cdots \sigma_{n}$) ending at $\sigma_i$ with maximum value $\sigma_i$ in the string.
\end{theorem}
