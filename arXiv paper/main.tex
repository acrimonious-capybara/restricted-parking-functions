...
\section{Introduction} \todo[jayden]{make this more friendly to someone who is coming from polytopes or with less background in PFs} \todo[jayden]{cite something that points to where a lot of other variations on PFs come from}
...
\begin{proof}
    ...
    Note first that $f_*$ is injective since $f$ is injective on $S$; it also takes preference functions with all preferences in $S$ to preference functions with all preferences in $[s].$
