...
\resPFcount* \todo[jayden, inline]{again, split (into two proofs, lemmas, and a definition of "valid colouring of parking functions") --- this needs to be attractive since it's the best part of the paper}
